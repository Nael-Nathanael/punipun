    ...
    <div class="row">
        <div class="col-lg-3 mb-4">
            ...
            <div class="imgStickContainer">
                <img alt="" class="mb-2" src="{PROFILE_1}">
        ...
        <div class="col-lg-9 mb-4">
            <h2 class="exo2 light mb-2">Puni's Profile</h2>
                    ...
                    <div>
                        <table>
                            ...
                            <tr>
                                <th>Birthday</th>
                                <td class="ps-3 pe-2">:</td>
                                <td>7 October 199<span class="blurry-text">x</span></td>
                            </tr>
                            <tr>
                                <th>Height</th>
                                <td class="ps-3 pe-2">:</td>
                        ...
                        <ul>
                            ...
                            <li>
                                Kurate Gakuen Moe Ambassador <img alt="🇯🇵" class="emoji" draggable="false"
                                                                  role="img"
                                                                  scale="0"
                            ...
                            <li>
                                NHK Kawai.i International <img alt="🇯🇵" class="emoji" draggable="false" role="img"
                                                               scale="0"
                                                               src="https://s0.wp.com/wp-content/mu-plugins/wpcom-smileys/twemoji/2/svg/1f1ef-1f1f5.svg">
                                #2 Viewer’s Choice
                            </li>
            ...
            <div class="card shadow-sm">
                <div class="card-body position-relative">
                    ...
                    <div>
                        ...
                        <ul>
                            <li>
                                Owner of <a class="text-decoration-none" href="https://g.page/punipun">Kopi Chuseyo
        ...
        <div class="col-lg-9 mb-4">
            <div class="card shadow-sm">
                <div class="card-body position-relative">
                    <h4 class="exo2 light mb-2">Portfolios</h4>
                    <div>
                        <b>Background:</b>
                        <ul>
                            <li>
